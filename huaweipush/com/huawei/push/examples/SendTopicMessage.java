...
public class SendTopicMessage
{
    public void sendToTopic() throws HuaweiMesssagingException {
        ...
        final Notification notification = Notification.builder().setTitle("send topic message title").setBody("send topic message title").build();
        ...
        final Message message = Message.builder().setNotification(notification).setAndroidConfig(androidConfig).setTopic("targetTopic").build();
